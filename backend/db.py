...
os.getenv("POSTGRES_URL") or f"postgresql://{DB_USER}:{DB_PASSWORD}@{DB_HOST}:{DB_PORT}/{DB_NAME}"
'''
...
if __name__ == "__main__":
    fetch_details(session,email="anasrahman8786@gmail.com")
    #users = fetch_users(db=session)
